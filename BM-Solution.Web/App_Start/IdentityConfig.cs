...
namespace BM_Solution.Web
{
    ...
    {
        public ApplicationUserStore(BmSolutionsDbContext context)
            : base(context)
        {
        }
    }
    public class ApplicationRoleManager : RoleManager<AppRole>
    {
        ...
        {
            return new ApplicationRoleManager(new RoleStore<AppRole>(context.Get<BmSolutionsDbContext>()));
        }
    }
    ...
    public class ApplicationUserManager : UserManager<AppUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<AppUser>(context.Get<BmSolutionsDbContext>()));
